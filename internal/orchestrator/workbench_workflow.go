...
var workbenchTransitions = map[workbench.TaskStatus][]workbench.TaskStatus{
	...
	workbench.TaskRunning:         {workbench.TaskInReview, workbench.TaskWaitingUser, workbench.TaskBlocked, workbench.TaskFailed},
	workbench.TaskInReview:        {workbench.TaskReady, workbench.TaskWaitingUser, workbench.TaskBlocked, workbench.TaskDone, workbench.TaskFailed},
	workbench.TaskWaitingUser:     {workbench.TaskPlanning, workbench.TaskReady, workbench.TaskRunning, workbench.TaskInReview, workbench.TaskBlocked, workbench.TaskFailed},
