...
- Hardened the CLI with install-aware `ao update`, startup update notifications, doctor version checks, JSON output for `to session ls`, config error handling, version mismatch fixes, and default filtering for terminated sessions.
