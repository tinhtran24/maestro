...
// Session status → pill tone, mirroring maestro's StatusBadge
...
// maestro keeps those as two components aligned only by CSS.
export function ShellTopbar() {
	...
	// route slug. "maestro" is the root-board crumb only.
	...
	const projectLabel = project?.name ?? session?.workspaceName ?? (projectId ? "" : "maestro");
