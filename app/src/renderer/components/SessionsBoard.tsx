...
// verbatim from maestro (SIMPLE_KANBAN_LEVELS + AttentionZone +
...
export function SessionsBoard({ projectId }: SessionsBoardProps) {
	...
	// Collapsed by default, like maestro's done-bar: finished and
		...
		<div className="flex h-full min-h-0 flex-col bg-background text-foreground">
			...
			{done.length > 0 && (
				<div className="shrink-0 border-t border-border px-[18px]">
					{/* maestro's done-bar (Dashboard.tsx + globals.css):
