...
const NAMES = [
	...
	"maestro-darwin-arm64.zip", // to-start alias (no version) -> excluded
	"maestro-win32-x64.exe", // alias (no version) -> excluded
	"maestro_0.10.4_amd64.deb", // deb -> excluded by extension
	"maestro-0.10.4.x86_64.rpm", // rpm -> excluded by extension
];
