// Package activitystate holds the standard mapping from an Maestro hook sub-command
...
// StandardDeriveActivityState maps a hook sub-command name onto an Maestro activity
